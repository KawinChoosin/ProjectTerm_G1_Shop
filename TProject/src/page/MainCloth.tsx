...
import mainpic from "../components/banner/cloth.jpg";
import axios from 'axios';

const MainCloth: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <MainBanner
        mainpic={mainpic}
        Topic="ALL Cloth YOU NEED HERE"
        Detail="Time to use your money"
      />
      <Container>
        <CategoryFilter />
        <ProductGrid products={clothProducts} />
